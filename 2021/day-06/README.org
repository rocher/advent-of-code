...
#+LATEX_HEADER: \usepackage[font={footnotesize,sf},labelfont=bf,justification=raggedright,singlelinecheck=false]{caption}
#+LATEX_HEADER: \pagestyle{fancy}
#+LATEX_HEADER: \pagestyle{etoolbox}
#+LATEX_HEADER: \hypersetup{colorlinks, linkcolor=black, urlcolor=blue, pdfborder={0 0 0}}
#+LATEX_HEADER: \renewcommand*\arraystretch{1.25}
#+LATEX_HEADER: \AtBeginEnvironment{tabular}{\ttfamily}
#+LATEX_HEADER: \AfterEndEnvironment{tabular}{\vspace{1em}}
#+LATEX_HEADER: \AtEndEnvironment{itemize}{\vspace{1em}}
#+LATEX_HEADER: \DefineVerbatimEnvironment{verbatim}{Verbatim}{xleftmargin=2em}
#+LATEX_HEADER: \AfterEndEnvironment{verbatim}{\vspace{1.2em}}
...
#+name: __Population_Size_After_80_Days__
#+begin_src ada
...
#+name: __Population_Size_After_256_Days__
#+begin_src ada
...
#+begin_src ada :exports both :unit day06_z1
  ...
  begin
     ...
     Open (Input, In_File, "__Current_Path__" & "input");
        <<__Read_And_Count_Lanternfish__>>
     Close (Input);

     Create (Output, Out_File,  "__Current_Path__" & "population");
        <<__Simulate_256_Days_And_Write_Population__>>
     Close (Output);
...
# End:
# (progn (load-file "./setup.el") (org-latex-export-to-pdf))
