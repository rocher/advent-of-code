...
timer value of =0= will have =1= in the first generation, =2= in the second and
...
#+name: __Read_And_Count_Lanterfish__
#+begin_src ada
...
#+begin_src ada :exports both :unit day06_z1
  ...
  begin
     ...
     Create (Output, Out_File,  "__Path__" & "population-80");
        <<__Simulate_256_Days_And_Write_Population__>>
     Close (Output);
  end Day06_Z1;
#+end_src
...
#+begin_src gnuplot :exports both :file population-80.png
  plot "population" every ::0::79:0 title "Lanterfish" with lines
#+end_src
...
#+begin_src gnuplot :exports both :file population-256.png
  plot "population" title "Lanterfish" with lines
#+end_src
