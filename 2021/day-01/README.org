...
*source code block* =d01p1__packages__=
...
*source code block* =d01p1__variables__=
...
*source code block* =d01p1__process__=
...
*** Result
The result just prints the number of increments counted.

*source code block* =d01p1__result__=
...
The compilation unit for this program is obtained with the composition of all
source code blocks. Evaluation of the program appears below.
...
when ~I=2~ then ~I+1=0~ refers to the /next/ window that will be updated. That
is, the oldest and complete of the three.

*** Declarations
Two types are declared to manage the measurement windows,

*source code block* =d01p2__types__=
#+name: d01p2__types__
#+begin_src ada
...
plus the ~Measurement_IO~ package:

*source code block* =d01p2__packages__=
...
*source code block* =d01p2__variables__=
...
*source code block* =d01p2__read_first_values__=
#+name: d01p2__read_first_values__
#+begin_src ada
...
=source code block d01p2__process_rest_of_input_values__=
#+name: d01p2__process_rest_of_input_values__
#+begin_src ada
  I := 2; --  current window
  loop
...
#+begin_src ada :exports both :noweb yes :unit day01_p2
  ...
  begin
     Open (Input, In_File, "/home/ada/advent-of-code/2021/day-01/input");
        <<d01p2__read_first_values__>>
        <<d01p2__process_rest_of_input_values__>>
     Close (Input);
...
Expanded code in [[file:src/day01_p2.adb]].
