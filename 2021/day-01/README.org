#+PROPERTY: header-args  :var __Path__=(file-name-directory (buffer-file-name (current-buffer)))
...
#+name: day01_p1
#+begin_src ada :exports both :noweb yes :tangle src/day01_p1.adb :unit day01_p1 :var __Path__=(file-name-directory (buffer-file-name (current-buffer)))
...
#+name: day01_p2
#+begin_src ada :exports both :tangle src/day01_p2.adb :unit day01_p2
  with Ada.Text_IO; use Ada.Text_IO;
