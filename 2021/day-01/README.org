...
The variables the process will use are:

  * =Input=: the input file
  * =Measurement= and =Previous_Measurement=, of type ~Natural~, to store the
    values read
  * =Increments=, of type ~Natural~ to count the total number of increments
    detected
